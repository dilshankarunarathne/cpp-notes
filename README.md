...
Similarly, we can capture everything local to the calling scope by reference, by passing [&]. We can mix and match these two approaches. Some by value and some by reference. 
